...
- (void)setupAllChildViewController {
    ...
    ProductHistoryViewController *fourVc = [[ProductHistoryViewController alloc] init];
    fourVc.title = @"回款计划";
...
- (void)setupBottomContentView {
    ...
    layout.itemSize = CGSizeMake(YYScreenW, YYScreenH - 164 - TitleHeight);
    ...
    [[UICollectionView alloc] initWithFrame:CGRectMake(0,TitleHeight, YYScreenW, YYScreenH - 164 - TitleHeight) collectionViewLayout:layout];
