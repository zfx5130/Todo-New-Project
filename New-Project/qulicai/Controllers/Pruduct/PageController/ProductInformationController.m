...
- (void)setupNavgationBar {
    ...
    UILabel *nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(15.0f, NavBarHeight, YYScreenW, NavBarHeight)];
    nameLabel.text = @"项目详情";
    ...
    UIScrollView *topView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, NavBarHeight * 2, YYScreenW, TitleHeight)];
...
- (void)setupBottomContentView
{
    ...
    layout.itemSize = CGSizeMake(YYScreenW, YYScreenH-TitleHeight- NavBarHeight * 2);
